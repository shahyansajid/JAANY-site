// choose which titles show in the header on the english site:
var titles_en = [
...
// choose which titles show in the header on the japanese site:
var titles_ja = [
                'ニューヨーク日系人会へようこそ',
                'Celebrating Over 100 Years of Community Service',
                'Dedicated to Engaging the Youth and Supporting the Elderly',
...
// choose which images show in the slider. images must be in the /images/ folder:
var images = [
                'matsuri.jpg',
                'sakura.jpg',
                'art.jpg',
...
var scholar_toemail = "scholarship@jaany.org";
  ...
  //=======================================================================================//
 //===== DO NOT EDIT CODE BELOW UNLESS FOLLOWING INSTRUCTIONS FROM THE DOCUMENTATION =====//
//=======================================================================================//
...
$(document).ready(function() {
	...
	// SCHOLARSHIP FORM SUBMISSION FUNCTION. EDIT AS PER THE DOCUMENTATION ONLY
